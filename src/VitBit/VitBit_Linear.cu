...
__global__ void VitBit_Linear(const int8_t* TC_input, const int8_t* TC_weight, int8_t* TC_output, 
    ...
    if((threadIdx.y < 1)) {
        ...
        CC_VitBit_gemm_kernel(CC_input_int, CC_weight_int, CC_output_int,
