...
int main(){
    ...
    int *Rearrange_CC_input = new int[224 * 224 * 3 * CC_WIDTH / (TC_WIDTH + CC_WIDTH)];
    initializeRandom_int(Rearrange_CC_input, 224 * 224 * 3 * CC_WIDTH / (TC_WIDTH + CC_WIDTH));
    ...
    int *Rearrange1_CC_output_GPU;
    cudaMalloc(&Rearrange1_CC_output_GPU, (CC_WIDTH*192) * sizeof(int));
    cudaMemcpy(Rearrange1_CC_output_GPU, Rearrange_CC_input, (CC_WIDTH*192) * sizeof(int), cudaMemcpyHostToDevice);

    /* Layer Normalization 2 */
    int8_t *Norm2_TC_gamma_CPU = new int8_t[192];
    initializeRandom_int8(Norm2_TC_gamma_CPU, 192);
    int *Norm2_CC_gamma_CPU = new int[192];
    initializeRandom_int(Norm2_CC_gamma_CPU, 192);
    ...
    int *Norm2_CC_gamma_GPU;
    cudaMalloc(&Norm2_CC_gamma_GPU, 192 * sizeof(int));
    cudaMemcpy(Norm2_CC_gamma_GPU, Norm2_CC_gamma_CPU, 192 * sizeof(int), cudaMemcpyHostToDevice);
    ...
    int *Norm2_CC_beta_CPU = new int[192];
    initializeRandom_int(Norm2_CC_beta_CPU, 192);
    int *Norm2_CC_beta_GPU;
    cudaMalloc(&Norm2_CC_beta_GPU, 192 * sizeof(int));
    cudaMemcpy(Norm2_CC_beta_GPU, Norm2_CC_beta_CPU, 192 * sizeof(int), cudaMemcpyHostToDevice);

    int8_t *Norm2_TC_output;
    cudaMalloc(&Norm2_TC_output, (TC_WIDTH*192) * sizeof(int8_t));
    int *Norm2_CC_output;
    cudaMalloc(&Norm2_CC_output, (CC_WIDTH*192) * sizeof(int));
    ...
    // CC Parameters
    int *Linear3_CC_weight_CPU = new int[192 * 768];
    initializeRandom_int(Linear3_CC_weight_CPU, 192 * 768);
    int *Linear3_CC_weight_GPU;
    cudaMalloc(&Linear3_CC_weight_GPU, (192 * 768) * sizeof(int));
    cudaMemcpy(Linear3_CC_weight_GPU, Linear3_CC_weight_CPU, (192 * 768) * sizeof(int), cudaMemcpyHostToDevice);

    int *Linear3_CC_bias_CPU = new int[768];
    initializeRandom_int(Linear3_CC_bias_CPU, 768);
    int *Linear3_CC_bias_GPU;
    cudaMalloc(&Linear3_CC_bias_GPU, 768 * sizeof(int));
    cudaMemcpy(Linear3_CC_bias_GPU, Linear3_CC_bias_CPU, 768 * sizeof(int), cudaMemcpyHostToDevice);

    int *Linear3_CC_output;
    cudaMalloc(&Linear3_CC_output, (CC_WIDTH*768) * sizeof(int));
    int *Linear3_1_CC_output;
    cudaMalloc(&Linear3_1_CC_output, (CC_WIDTH*768) * sizeof(int));
    ...
    // CC Parameters
    int *Norm4_CC_gamma_CPU = new int[768];
    initializeRandom_int(Norm4_CC_gamma_CPU, 768);
    int *Norm4_CC_gamma_GPU;
    cudaMalloc(&Norm4_CC_gamma_GPU, 768 * sizeof(int));
    cudaMemcpy(Norm4_CC_gamma_GPU, Norm4_CC_gamma_CPU, 768 * sizeof(int), cudaMemcpyHostToDevice);

    int *Norm4_CC_beta_CPU = new int[768];
    initializeRandom_int(Norm4_CC_beta_CPU, 768);
    int *Norm4_CC_beta_GPU;
    cudaMalloc(&Norm4_CC_beta_GPU, 768 * sizeof(int));
    cudaMemcpy(Norm4_CC_beta_GPU, Norm4_CC_beta_CPU, 768 * sizeof(int), cudaMemcpyHostToDevice);

    int *Norm4_CC_output;
    cudaMalloc(&Norm4_CC_output, (CC_WIDTH*768) * sizeof(int));
    ...
    // CC Parameters
    int *Drop5_CC_output;
    cudaMalloc(&Drop5_CC_output, (CC_WIDTH*768) * sizeof(int));
    ...
    // CC Parameters
    int *Norm6_CC_gamma_CPU = new int[768];
    initializeRandom_int(Norm6_CC_gamma_CPU, 768);
    int *Norm6_CC_gamma_GPU;
    cudaMalloc(&Norm6_CC_gamma_GPU, 768 * sizeof(int));
    cudaMemcpy(Norm6_CC_gamma_GPU, Norm6_CC_gamma_CPU, 768 * sizeof(int), cudaMemcpyHostToDevice);

    int *Norm6_CC_beta_CPU = new int[768];
    initializeRandom_int(Norm6_CC_beta_CPU, 768);
    int *Norm6_CC_beta_GPU;
    cudaMalloc(&Norm6_CC_beta_GPU, 768 * sizeof(int));
    cudaMemcpy(Norm6_CC_beta_GPU, Norm6_CC_beta_CPU, 768 * sizeof(int), cudaMemcpyHostToDevice);

    int *Norm6_CC_output;
    cudaMalloc(&Norm6_CC_output, (CC_WIDTH*768) * sizeof(int));
    ...
    // CC Parameters
    int *Linear7_CC_weight_CPU[num_iteration];
    int *Linear7_CC_weight_GPU[num_iteration];
    int *Linear7_CC_bias_CPU[num_iteration];
    int *Linear7_CC_bias_GPU[num_iteration];
    int *Linear7_CC_output[num_iteration];
    int *Linear7_1_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Soft8_CC_output[num_iteration];
    ...
    // CC Parametsers
    int *Drop9_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Linear10_CC_weight_CPU[num_iteration];
    int *Linear10_CC_weight_GPU[num_iteration];
    int *Linear10_CC_bias_CPU[num_iteration];
    int *Linear10_CC_bias_GPU[num_iteration];
    int *Linear10_CC_output[num_iteration];
    int *Linear10_1_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Drop11_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Norm13_CC_gamma_CPU[num_iteration];
    int *Norm13_CC_gamma_GPU[num_iteration];
    int *Norm13_CC_beta_CPU[num_iteration];
    int *Norm13_CC_beta_GPU[num_iteration];
    int *Norm13_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Linear14_CC_weight_CPU[num_iteration];
    int *Linear14_CC_weight_GPU[num_iteration];
    int *Linear14_CC_bias_CPU[num_iteration];
    int *Linear14_CC_bias_GPU[num_iteration];
    int *Linear14_CC_output[num_iteration];
    int *Linear14_1_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Gelu15_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Drop16_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Linear17_CC_weight_CPU[num_iteration];
    int *Linear17_CC_weight_GPU[num_iteration];
    int *Linear17_CC_bias_CPU[num_iteration];
    int *Linear17_CC_bias_GPU[num_iteration];
    int *Linear17_CC_output[num_iteration];
    int *Linear17_1_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Drop18_CC_output[num_iteration];
    ...
    // CC Parameters
    int *Norm20_CC_gamma_CPU[num_iteration];
    int *Norm20_CC_gamma_GPU[num_iteration];
    int *Norm20_CC_beta_CPU[num_iteration];
    int *Norm20_CC_beta_GPU[num_iteration];
    int *Norm20_CC_output[num_iteration];
    ...
    for(int i = 0; i < num_iteration; ++i){
        ...
        // CC Parameters
        Linear7_CC_weight_CPU[i] = new int[768 * 2304];
        initializeRandom_int(Linear7_CC_weight_CPU[i], 768 * 2304);
        cudaMalloc(&Linear7_CC_weight_GPU[i], (768 * 2304) * sizeof(int));
        cudaMemcpy(Linear7_CC_weight_GPU[i], Linear7_CC_weight_CPU[i], (768 * 2304) * sizeof(int), cudaMemcpyHostToDevice);
        Linear7_CC_bias_CPU[i] = new int[2304];
        initializeRandom_int(Linear7_CC_bias_CPU[i], 2304);   
        cudaMalloc(&Linear7_CC_bias_GPU[i], 2304 * sizeof(int));
        cudaMemcpy(Linear7_CC_bias_GPU[i], Linear7_CC_bias_CPU[i], 2304 * sizeof(int), cudaMemcpyHostToDevice);
        cudaMalloc(&Linear7_CC_output[i], (CC_WIDTH*2304) * sizeof(int));
        cudaMalloc(&Linear7_1_CC_output[i], (CC_WIDTH*2304) * sizeof(int));
        ...
        // CC Parameters
        cudaMalloc(&Soft8_CC_output[i], (CC_WIDTH*2304) * sizeof(int));
        ...
        // CC Parameters
        cudaMalloc(&Drop9_CC_output[i], (CC_WIDTH*768) * sizeof(int));
        ...
        // CC Parameters
        Linear10_CC_weight_CPU[i] = new int[768 * 768];
        initializeRandom_int(Linear10_CC_weight_CPU[i], 768 * 768);
        cudaMalloc(&Linear10_CC_weight_GPU[i], (768 * 768) * sizeof(int));
        cudaMemcpy(Linear10_CC_weight_GPU[i], Linear10_CC_weight_CPU[i], (768 * 768) * sizeof(int), cudaMemcpyHostToDevice);
        Linear10_CC_bias_CPU[i] = new int[768];
        initializeRandom_int(Linear10_CC_bias_CPU[i], 768);
        cudaMalloc(&Linear10_CC_bias_GPU[i], 768 * sizeof(int));
        cudaMemcpy(Linear10_CC_bias_GPU[i], Linear10_CC_bias_CPU[i], 768 * sizeof(int), cudaMemcpyHostToDevice);
        cudaMalloc(&Linear10_CC_output[i], (CC_WIDTH*768) * sizeof(int));
        cudaMalloc(&Linear10_1_CC_output[i], (CC_WIDTH*768) * sizeof(int));
        ...
        // CC Parameters
        cudaMalloc(&Drop11_CC_output[i], (CC_WIDTH*768) * sizeof(int));
        ...
        // CC Parameters
        Norm13_CC_gamma_CPU[i] = new int[768];
        initializeRandom_int(Norm13_CC_gamma_CPU[i], 768);
        cudaMalloc(&Norm13_CC_gamma_GPU[i], 768 * sizeof(int));
        cudaMemcpy(Norm13_CC_gamma_GPU[i], Norm13_CC_gamma_CPU[i], 768 * sizeof(int), cudaMemcpyHostToDevice);
        Norm13_CC_beta_CPU[i] = new int[768];
        initializeRandom_int(Norm13_CC_beta_CPU[i], 768);
        cudaMalloc(&Norm13_CC_beta_GPU[i], 768 * sizeof(int));
        cudaMemcpy(Norm13_CC_beta_GPU[i], Norm13_CC_beta_CPU[i], 768 * sizeof(int), cudaMemcpyHostToDevice);
        cudaMalloc(&Norm13_CC_output[i], (CC_WIDTH*768) * sizeof(int));
        ...
        // CC Parameters
        Linear14_CC_weight_CPU[i] = new int[768 * 3072];
        initializeRandom_int(Linear14_CC_weight_CPU[i], 768 * 3072);
        cudaMalloc(&Linear14_CC_weight_GPU[i], (768 * 3072) * sizeof(int));
        cudaMemcpy(Linear14_CC_weight_GPU[i], Linear14_CC_weight_CPU[i], (768 * 3072) * sizeof(int), cudaMemcpyHostToDevice);
        Linear14_CC_bias_CPU[i] = new int[3072];
        initializeRandom_int(Linear14_CC_bias_CPU[i], 3072);
        cudaMalloc(&Linear14_CC_bias_GPU[i], 3072 * sizeof(int));
        cudaMemcpy(Linear14_CC_bias_GPU[i], Linear14_CC_bias_CPU[i], 3072 * sizeof(int), cudaMemcpyHostToDevice);
        cudaMalloc(&Linear14_CC_output[i], (CC_WIDTH*3072) * sizeof(int));
        cudaMalloc(&Linear14_1_CC_output[i], (CC_WIDTH*3072) * sizeof(int));
        ...
        // CC Parameters
        cudaMalloc(&Gelu15_CC_output[i], (CC_WIDTH*3072) * sizeof(int));
        ...
        // CC Parameters
        cudaMalloc(&Drop16_CC_output[i], (CC_WIDTH*3072) * sizeof(int));
        ...
        // CC Parameters
        Linear17_CC_weight_CPU[i] = new int[768 * 3072];
        initializeRandom_int(Linear17_CC_weight_CPU[i], 768 * 3072);
        cudaMalloc(&Linear17_CC_weight_GPU[i], (768 * 3072) * sizeof(int));
        cudaMemcpy(Linear17_CC_weight_GPU[i], Linear17_CC_weight_CPU[i], (768 * 3072) * sizeof(int), cudaMemcpyHostToDevice);
        Linear17_CC_bias_CPU[i] = new int[768];
        initializeRandom_int(Linear17_CC_bias_CPU[i], 768);
        cudaMalloc(&Linear17_CC_bias_GPU[i], 3072 * sizeof(int));
        cudaMemcpy(Linear17_CC_bias_GPU[i], Linear17_CC_bias_CPU[i], 768 * sizeof(int), cudaMemcpyHostToDevice);
        cudaMalloc(&Linear17_CC_output[i], (CC_WIDTH*768) * sizeof(int));
        cudaMalloc(&Linear17_1_CC_output[i], (CC_WIDTH*768) * sizeof(int));
        ...
        // CC Parameters
        cudaMalloc(&Drop18_CC_output[i], (CC_WIDTH*768) * sizeof(int));
        ...
        // CC Parameters
        Norm20_CC_gamma_CPU[i] = new int[768];
        initializeRandom_int(Norm20_CC_gamma_CPU[i], 768);
        cudaMalloc(&Norm20_CC_gamma_GPU[i], 768 * sizeof(int));
        cudaMemcpy(Norm20_CC_gamma_GPU[i], Norm20_CC_gamma_CPU[i], 768 * sizeof(int), cudaMemcpyHostToDevice);
        Norm20_CC_beta_CPU[i] = new int[768];
        initializeRandom_int(Norm20_CC_beta_CPU[i], 768);
        cudaMalloc(&Norm20_CC_beta_GPU[i], 768 * sizeof(int));
        cudaMemcpy(Norm20_CC_beta_GPU[i], Norm20_CC_beta_CPU[i], 768 * sizeof(int), cudaMemcpyHostToDevice);
        cudaMalloc(&Norm20_CC_output[i], (CC_WIDTH*768) * sizeof(int));
    }
    ...
    TC_INT_Normalization<<<dimGrid2,dimBlock>>>(Rearrange1_TC_output_GPU, Norm2_TC_output, Norm2_TC_gamma_GPU, Norm2_TC_beta_GPU,
    ...
    TC_INT_Linear<<<dimGrid3,dimBlock>>>(Norm2_TC_output, Linear3_TC_weight_GPU, Linear3_TC_output, 
    ...
    TC_INT_Add<<<dimGrid3_1,dimblock3_1>>>(Linear3_TC_output, Linear3_TC_bias_GPU, Linear3_1_TC_output,
                                            Linear3_CC_output, Linear3_CC_bias_GPU, Linear3_1_CC_output,
                                            TC_WIDTH, CC_WIDTH);

    /* Layer Normalization 4 */
    dim3 dimGrid4(ceil(768/block_size1), ceil(TOTAL_WIDTH/block_size2));
    TC_INT_Normalization<<<dimGrid4,dimBlock>>>(Linear3_1_TC_output, Norm4_TC_output, Norm4_TC_gamma_GPU, Norm4_TC_beta_GPU, 
    ...
    TC_INT_Dropout<<<dimGrid5, dimBlock>>>(Norm4_TC_output, Drop5_TC_output, 
    ...
    TC_INT_Normalization<<<dimGrid6,dimBlock>>>(Drop5_TC_output, Norm6_TC_output, Norm6_TC_gamma_GPU, Norm6_TC_beta_GPU, 
    ...
    for(int i = 0; i < num_iteration; ++i){
        if(i == 0){
            ...
            TC_INT_Linear<<<dimGrid7,dimBlock>>>(Norm6_TC_output, Linear7_TC_weight_GPU[i], Linear7_TC_output[i], 
            ...
            /* Linear 7 */
            dim3 dimGrid7(ceil(TC_WIDTH/warp_size), ceil(2304/warp_size));
            TC_INT_Linear<<<dimGrid7,dimBlock>>>(Norm20_TC_output[i-1], Linear7_TC_weight_GPU[i], Linear7_TC_output[i], 
        ...
        TC_INT_Add<<<dimGrid7_1,dimblock7_1>>>(Linear7_TC_output[i], Linear7_TC_bias_GPU[i], Linear7_1_TC_output[i],
        ...
        TC_INT_Softmax<<<dimGrid8, dimBlock>>>(Linear7_1_TC_output[i], Soft8_TC_output[i],
        ...
        TC_INT_Dropout<<<dimGrid9, dimBlock>>>(Soft8_TC_output[i], Drop9_TC_output[i], 
        ...
        TC_INT_Linear<<<dimGrid10,dimBlock>>>(Drop9_TC_output[i], Linear10_TC_weight_GPU[i], Linear10_TC_output[i],
        ...
        TC_INT_Add<<<dimGrid10_1,dimblock10_1>>>(Linear10_TC_output[i], Linear10_TC_bias_GPU[i], Linear10_1_TC_output[i],
        ...
        TC_INT_Dropout<<<dimGrid11, dimBlock>>>(Linear10_1_TC_output[i], Drop11_TC_output[i], 
        ...
        TC_INT_Normalization<<<dimGrid13,dimBlock>>>(Drop11_TC_output[i], Norm13_TC_output[i], Norm13_TC_gamma_GPU[i], Norm13_TC_beta_GPU[i], 
        ...
        TC_INT_Linear<<<dimGrid14,dimBlock>>>(Norm13_TC_output[i], Linear14_TC_weight_GPU[i], Linear14_TC_output[i], 
        ...
        TC_INT_Add<<<dimGrid14_1,dimblock14_1>>>(Linear14_TC_output[i], Linear14_TC_bias_GPU[i], Linear14_1_TC_output[i],
        ...
        TC_INT_Gelu<<<dimGrid15,dimBlock>>>(Linear14_1_TC_output[i], Gelu15_TC_output[i], 
        ...
        TC_INT_Dropout<<<dimGrid16, dimBlock>>>(Gelu15_TC_output[i], Drop16_TC_output[i], 
        ...
        TC_INT_Linear<<<dimGrid17,dimBlock>>>(Drop16_TC_output[i], Linear17_TC_weight_GPU[i], Linear17_TC_output[i], 
        ...
        TC_INT_Add<<<dimGrid17_1,dimblock17_1>>>(Linear17_TC_output[i], Linear17_TC_bias_GPU[i], Linear17_1_TC_output[i],
        ...
        TC_INT_Dropout<<<dimGrid18, dimBlock>>>(Linear17_1_TC_output[i], Drop18_TC_output[i], 
        ...
        TC_INT_Normalization<<<dimGrid20,dimBlock>>>(Drop18_TC_output[i], Norm20_TC_output[i], Norm20_TC_gamma_GPU[i], Norm20_TC_beta_GPU[i], 
