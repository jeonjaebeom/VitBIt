...
#include "TC_INT_FP_Functions.cuh"
...
int main(){
    ...
    TC_INT_FP_Normalization<<<dimGrid2,dimBlock>>>(Rearrange1_TC_output_GPU, Norm2_TC_output, Norm2_TC_gamma_GPU, Norm2_TC_beta_GPU,
    ...
    TC_INT_FP_Linear<<<dimGrid3,dimBlock>>>(Norm2_TC_output, Linear3_TC_weight_GPU, Linear3_TC_output, 
    ...
    TC_INT_FP_Add<<<dimGrid3_1,dimblock3_1>>>(Linear3_TC_output, Linear3_TC_bias_GPU, Linear3_1_TC_output,
    ...
    TC_INT_FP_Normalization<<<dimGrid4,dimBlock>>>(Linear3_1_TC_output, Norm4_TC_output, Norm4_TC_gamma_GPU, Norm4_TC_beta_GPU, 
    ...
    TC_INT_FP_Dropout<<<dimGrid5, dimBlock>>>(Norm4_TC_output, Drop5_TC_output, 
    ...
    TC_INT_FP_Normalization<<<dimGrid6,dimBlock>>>(Drop5_TC_output, Norm6_TC_output, Norm6_TC_gamma_GPU, Norm6_TC_beta_GPU, 
    ...
    for(int i = 0; i < num_iteration; ++i){
        if(i == 0){
            ...
            TC_INT_FP_Linear<<<dimGrid7,dimBlock>>>(Norm6_TC_output, Linear7_TC_weight_GPU[i], Linear7_TC_output[i], 
            ...
            /* Linear 7 */
            dim3 dimGrid7(ceil(TC_WIDTH/warp_size), ceil(2304/warp_size));
            TC_INT_FP_Linear<<<dimGrid7,dimBlock>>>(Norm20_TC_output[i-1], Linear7_TC_weight_GPU[i], Linear7_TC_output[i], 
        ...
        TC_INT_FP_Add<<<dimGrid7_1,dimblock7_1>>>(Linear7_TC_output[i], Linear7_TC_bias_GPU[i], Linear7_1_TC_output[i],
        ...
        TC_INT_FP_Softmax<<<dimGrid8, dimBlock>>>(Linear7_1_TC_output[i], Soft8_TC_output[i],
        ...
        TC_INT_FP_Dropout<<<dimGrid9, dimBlock>>>(Soft8_TC_output[i], Drop9_TC_output[i], 
        ...
        TC_INT_FP_Linear<<<dimGrid10,dimBlock>>>(Drop9_TC_output[i], Linear10_TC_weight_GPU[i], Linear10_TC_output[i],
        ...
        TC_INT_FP_Add<<<dimGrid10_1,dimblock10_1>>>(Linear10_TC_output[i], Linear10_TC_bias_GPU[i], Linear10_1_TC_output[i],
        ...
        TC_INT_FP_Dropout<<<dimGrid11, dimBlock>>>(Linear10_1_TC_output[i], Drop11_TC_output[i], 
        ...
        TC_INT_FP_Normalization<<<dimGrid13,dimBlock>>>(Drop11_TC_output[i], Norm13_TC_output[i], Norm13_TC_gamma_GPU[i], Norm13_TC_beta_GPU[i], 
        ...
        TC_INT_FP_Linear<<<dimGrid14,dimBlock>>>(Norm13_TC_output[i], Linear14_TC_weight_GPU[i], Linear14_TC_output[i], 
        ...
        TC_INT_FP_Add<<<dimGrid14_1,dimblock14_1>>>(Linear14_TC_output[i], Linear14_TC_bias_GPU[i], Linear14_1_TC_output[i],
        ...
        TC_INT_FP_Gelu<<<dimGrid15,dimBlock>>>(Linear14_1_TC_output[i], Gelu15_TC_output[i], 
        ...
        TC_INT_FP_Dropout<<<dimGrid16, dimBlock>>>(Gelu15_TC_output[i], Drop16_TC_output[i], 
        ...
        TC_INT_FP_Linear<<<dimGrid17,dimBlock>>>(Drop16_TC_output[i], Linear17_TC_weight_GPU[i], Linear17_TC_output[i], 
        ...
        TC_INT_FP_Add<<<dimGrid17_1,dimblock17_1>>>(Linear17_TC_output[i], Linear17_TC_bias_GPU[i], Linear17_1_TC_output[i],
        ...
        TC_INT_FP_Dropout<<<dimGrid18, dimBlock>>>(Linear17_1_TC_output[i], Drop18_TC_output[i], 
        ...
        TC_INT_FP_Normalization<<<dimGrid20,dimBlock>>>(Drop18_TC_output[i], Norm20_TC_output[i], Norm20_TC_gamma_GPU[i], Norm20_TC_beta_GPU[i], 
